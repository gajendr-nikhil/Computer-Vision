...
class Ps5Arrays:
    ...
    def __init__(self):
        ...
        #self.trans_a = cv2.imread(os.path.join(input_dir, "check_rot.bmp"), 0) / 255.
        #self.trans_b = cv2.imread(os.path.join(input_dir, "check.bmp"), 0) / 255.
        #self.sim_b = cv2.imread(os.path.join(input_dir, "check_rot.bmp"), 0) / 255.
        #self.sim_a = cv2.imread(os.path.join(input_dir, "check.bmp"), 0) / 255.
